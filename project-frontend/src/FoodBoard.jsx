...
const FoodBoard = () => {
  const posts = [
    ...
    },
    {
      id: 3,
      title: "中目黒のお洒落な薪窯ピザ🍕",
      content: "生地がモチモチで香ばしい！本格的なナ폴리피자(나폴리피자)가 즐길 수 있습니다. 데이트나 여자 모임에도 추천!",
      meta: "12/24 | 作成者",
    ...
    },
    {
      ...
      content: "新鮮なマグロとアボカドがたっぷり！トッピングも選べて、ダイエット 중 점심으로 딱 좋은 포케입니다.",
      meta: "12/24 | 作成者",
  ...
  return (
    <div className="board-container">
      ...
      <div className="write-button-container">
        <button className="write-button">글쓰기 ✏️</button>
      </div>
    </div>
  );
};
